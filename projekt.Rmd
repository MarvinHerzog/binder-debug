...
```{r glede na povprečje, message=FALSE, fig.align='center', fig.cap='povezava med efektivnostjo meta in plačo glede na povprečje'}
...
```{r fiba.lestvica populacija,  message=FALSE, fig.align='center', fig.cap='povezava med številom igralcev in populacijo'}
