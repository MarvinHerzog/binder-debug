...
```{r glede na povprečje, message=FALSE, echo=F,fig.align='center', fig.cap='povezava med efektivnostjo meta in plačo glede na povprečje'}
...
```{r fiba.lestvica populacija,  echo=F,message=FALSE, fig.align='center', fig.cap='povezava med številom igralcev in populacijo'}
